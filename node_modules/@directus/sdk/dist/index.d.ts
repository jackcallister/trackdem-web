...
declare class CollectionsHandler<T = CollectionItem> {
    ...
    createOne(collection: ItemInput<T>): Promise<OneItem<T>>;
    createMany(collections: ItemInput<T>[]): Promise<ManyItems<T>>;
    updateOne(collection: string, item: ItemInput<T>, query?: QueryOne<T>): Promise<OneItem<T>>;
...
declare class FieldsHandler<T = FieldItem> {
    ...
    readAll(): Promise<ManyItems<T>>;
    createOne(collection: string, item: ItemInput<T>): Promise<OneItem<T>>;
